...
package com.example.transportclient.decode;
...
import com.example.transportclient.ScannerActivity;
import com.example.transportclient.tess.TessEngine;
        ...
        try {
            ...
            if (mActivity.isQRCode()) {
                ...
                if (!TextUtils.isEmpty(result)) {
                    rawResult = new com.google.zxing.Result(result, null, null, null);
